...
class PhysicalLayer():
    ...
    def create_epr_pair(self, qubit1: Qubit, qubit2: Qubit):
        ...
        fidelity_qubit_epr = fidelity_qubit1 * fidelity_qubit2
        epr = Epr([qubit1, qubit2], fidelity_qubit_epr)
    ...
    def echp_on_demand(self, alice_host_id: int, bob_host_id: int):
        ...
        """
        Protocolo para a recriação de um entrelaçamento entre os qubits de acordo com a probablidade de sucesso de demanda do par EPR criado
        ...
        # Proabilidade de Sucesso do ECHP: Prob_demand_epr_create * Fidelidade_qubit1* Fidelidade_qubit2
    ...
    def echp_on_replay(self, alice_host_id: int, bob_host_id: int):
        ...
        echp_success_probability = prob_replay_epr_create * fidelidade_qubit1 * fidelidade_qubit2
